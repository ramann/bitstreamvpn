...
INSERT INTO `subscription_package` (name, duration, certs, bytes, price) VALUES ("Budget Weekend", 3, 1, 6000000000, 1.0); -- 3 days, 6 GB, $1, 1 device ; 2.0 GB/device/day; (1/3)/1/6=0.05555
INSERT INTO `subscription_package` (name, duration, certs, bytes, price) VALUES ("Week-long Warrior", 7, 2, 50000000000, 5.0); -- 7 days, 50 GB, $5, 2 devices ; 2.14 GB/device/day; (5/7)/2/50=0.00714
INSERT INTO `subscription_package` (name, duration, certs, bytes, price) VALUES ("Month-long Maniac", 30, 5, 300000000000, 10.0); -- 30 days, 300 GB, $12, 4 devices ; 2.5 GB/device/day; (12/30)/4/300=0.00033
...
drop table if exists `connections`; -- rename this, it just maps nflog group number (id) to peer's subject (peer_id)
